...
<body>
        ...
        <div class="y-ai-k">
            <div class="y-ai-k-in">
                ...
                <div class="y-ai-k-l">
                    ...
                    <h2>
                        <span id="y-chicang">0.00</span>
                        <span>USDT</span>
                    </h2>
                    <a href="{{ route('ai-record') }}" data-translate="托管订单" class="y-tgdd">Escrow order</a>
                </div>
            </div>
            <div class="y-ai-sy">
                <div class="y-ai-sy-z">
                    ...
                    <div>
                        ...
                        <p>
                            $<span id="y-zongshouyi">0.00</span>
                        </p>
                    </div>
                </div>
                <div class="y-ai-sy-j">
                    ...
                    <div>
                        ...
                        <p>
                            $<span id="y-jinrishouyi">0.00</span>
                        </p>
                    </div>
                </div>
    ...
    <div class="y-ai">
        <div class="y-ai-buy">
            <div class="y-ai-bbox">
                ...
                <div class="y-ai-bbtit">Daily income</div>
                <div class="y-ai-bbje">
                    <span>1.60-1.80</span>%
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $.post(apiurl + "/Ai/getailist", {}, function(res) {
                if (res.code == 1) {
                    let data = res.data;
                    let html = '';
                    ...
                    data.forEach(function(item) {
                        ...
                        html += `
                                ...
                                <div class="y-ai-bbje">
                                    $${item.buyxiao}-$${item.buyda}
                                </div>
                                <div class="y-ai-bbtit">${gy('每日收入')}</div>
                                <div class="y-ai-bbje">
                                    <span>${item.bilixiao}-${item.bilida}</span>%
                                </div>
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res.code == 1) {
                        $('#y-zongshouyi').text(Number(res.data.total_jine).toFixed(2));
                        $('#y-jinrishouyi').text(Number(res.data.recent_jine).toFixed(2));
                        $('#y-chicang').text(Number(res.data.total_shuliang).toFixed(2));
                    } else {
                        alert(gy(res.data));
                    }
                }
