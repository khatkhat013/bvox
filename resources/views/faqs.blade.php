<!DOCTYPE html>
<html lang="en" style="font-size: 18.36px;">
<head>
...
<body>
    <div class="y-hd">
        <div class="yc-header">
            ...
            <div class="y-title" data-translate="常见问题">FAQs</div>
        </div>
    </div>

    <div class="y-article" style="padding-top: 4rem; min-height: 952px;">
        <p style="padding: 20px;font-size: 16px;">What are futures<br><br>Options are financial instruments that provide
            ...
            ETH.<br><br>Newcomers to options contracts can learn about:<br><br>• A put option represents the right (not
            ...
            at a higher price (called the strike price) and make a profit.<br><br>• A call option represents the
            ...
            purchase the asset at a lower price and make a profit<br><br><br><br>What can be done on the Crypto Ranch
            futures trading platform?<br><br><br>You can perform three main operations on this platform: ·Futures
            trading ·Arbitrage trading ·Mining trading<br><br><br><br>What are the contract trading
            rules?<br><br>Transaction Type<br><br>Transaction types are divided into two directions: long position
            opening (buying) and short position opening (selling):<br><br>Buying long (bullish) means that you believe
            that the current index is likely to rise and hope to buy a certain number of new contracts at the price you
            set or the current market price.<br><br>Short selling (position) means that you believe that the current
            index is likely to fall and hope to sell a certain number of new contracts at a price you set or the current
            market price.<br><br>Ordering method<br><br>Limit order: You need to specify the price and quantity of the
            order yourself<br><br>Market order: You only need to set the order quantity, and the price will be the
            current market price<br><br><br><br>Is it safe?<br><br><br>We work very hard to ensure every aspect of the
            ...
            to the underlying smart contracts.<br><br><br><br><br>How can you succeed in digital currency
            trading?<br><br>After investors understand the rules of digital currency trading, they may also want to
            ...
            we truly achieve our goals and bring more benefits to investors.<br><br>Everyone wants to gain wealth, and
            ...
            control. This is also an important content.<br><br><br><br>What are the rules for digital currency
            trading?<br><br>When you understand the rules of digital currency trading, you will find that it is
            ...
            to a reward. Generally speaking, do you know what the rules are in between?<br><br>First of all, the trading
            ...
            day. Cash can also be withdrawn at any time, and the liquidity of funds is relatively high.<br><br>The rules
            ...
            naturally be executed quickly.<br>If your account has not been traded for more than 10 days, the funds will
            be automatically handed over to the system for custody and the corresponding custody fee will be charged
            according to the number of days of custody.<br><br><br>Is it entirely on the blockchain?<br><br>We use a
            ...
            structure for market makers and is designed to promote excellent liquidity.<br><br><br><br>Who can use the
            decentralized futures trading platform?<br><br>When our platform first launches, we will be available to
            everyone. There is currently no centralized process for account creation and no planned restrictions on our
            users.<br><br><br><br>What is a credit score?<br><br>Refers to a statistical and evaluation system that
            ...
            lines.<br><br>Credit score:<br><br>580 points-620 points: Maximum weekly withdrawal is $10,000 USD or coin
            equivalent.<br><br>621 points-650 points: Maximum weekly withdrawal is $50,000 USD or coin
            equivalent.<br><br>651 points-680 points: The maximum weekly withdrawal is US$100,000 or its
            equivalent.<br><br>681 points-720 points: The maximum weekly withdrawal is US$500,000 or its
            equivalent.<br><br>721 points: Unlimited withdrawals and above.<br><br>Credit scores can be obtained from
            the bank providing credit or from Crypto Ranch's internal system<br><br></p>
    </div>
